...
public class CardCreateLodgedCardRequest {
  ...
  public CardCreateLodgedCardRequest() {
  }

  public CardCreateLodgedCardRequest merchantGuid(String merchantGuid) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest firstName(String firstName) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest lastName(String lastName) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest phone(String phone) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest address1(String address1) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest address2(String address2) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest city(String city) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest state(String state) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest zipCode(String zipCode) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest country(String country) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest usageLimit(Long usageLimit) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest amountLimit(Float amountLimit) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest limitWindow(String limitWindow) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "This is the time period that both the UsageLimit and the AmountLimit applies. Options are: Day, Week, Month, Lifetime. For example AmountLimit is $500 and LimitWindow is \"Week\" then the card can be approved for $500 per week.")
  ...
  public CardCreateLodgedCardRequest expirationDate(LocalDate expirationDate) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest terminateDate(LocalDate terminateDate) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest purchaseType(String purchaseType) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest sequenceNumber(String sequenceNumber) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest orderNumber(String orderNumber) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest supplierId(String supplierId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The SupplierId is used to assist with Intelligent Routing functionality. In many cases, a Lodged Card is used at several different suppliers. In this case, there may be no reason to include SupplierId. However, if the Lodged Card will be used at a single supplier, we recommend sending in the SupplierId to assist with acceptance and rebate. The field accepts up to 100 alpha-numeric characters.")
  ...
  public CardCreateLodgedCardRequest nonDomesticSupplier(Boolean nonDomesticSupplier) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest transmission(CardCreateLodgedCardRequestTransmission transmission) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequestTransmission getTransmission() {
    return transmission;
  }


  public void setTransmission(CardCreateLodgedCardRequestTransmission transmission) {
  ...
  public CardCreateLodgedCardRequest returnCardData(Boolean returnCardData) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest customerID(String customerID) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest associationId(String associationId) {
  ...
  **/
  ...
  public CardCreateLodgedCardRequest labelIDs(List<String> labelIDs) {
  ...
  public CardCreateLodgedCardRequest addLabelIDsItem(String labelIDsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Utilize Label IDs to associate a lodged card to a specific label(s) within ConnexPay Bridge UI for your organization. If a lodged card is tied to an incorrect Label, it will not filter or display correctly in Bridge's Search Grid. Please contact your Customer Care Consultant for a list of valid Label IDs before use.")
  ...
  public CardCreateLodgedCardRequest customParameters(List<CardIssuanceCreateVirtualCardRequestCustomParametersInner> customParameters) {
  ...
  public CardCreateLodgedCardRequest addCustomParametersItem(CardIssuanceCreateVirtualCardRequestCustomParametersInner customParametersItem) {
  ...
  **/
   ...
   * @return the CardCreateLodgedCardRequest instance itself
   */
  public CardCreateLodgedCardRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CardCreateLodgedCardRequest cardCreateLodgedCardRequest = (CardCreateLodgedCardRequest) o;
    return Objects.equals(this.merchantGuid, cardCreateLodgedCardRequest.merchantGuid) &&
        Objects.equals(this.firstName, cardCreateLodgedCardRequest.firstName) &&
        Objects.equals(this.lastName, cardCreateLodgedCardRequest.lastName) &&
        Objects.equals(this.phone, cardCreateLodgedCardRequest.phone) &&
        Objects.equals(this.address1, cardCreateLodgedCardRequest.address1) &&
        Objects.equals(this.address2, cardCreateLodgedCardRequest.address2) &&
        Objects.equals(this.city, cardCreateLodgedCardRequest.city) &&
        Objects.equals(this.state, cardCreateLodgedCardRequest.state) &&
        Objects.equals(this.zipCode, cardCreateLodgedCardRequest.zipCode) &&
        Objects.equals(this.country, cardCreateLodgedCardRequest.country) &&
        Objects.equals(this.usageLimit, cardCreateLodgedCardRequest.usageLimit) &&
        Objects.equals(this.amountLimit, cardCreateLodgedCardRequest.amountLimit) &&
        Objects.equals(this.limitWindow, cardCreateLodgedCardRequest.limitWindow) &&
        Objects.equals(this.expirationDate, cardCreateLodgedCardRequest.expirationDate) &&
        Objects.equals(this.terminateDate, cardCreateLodgedCardRequest.terminateDate) &&
        Objects.equals(this.purchaseType, cardCreateLodgedCardRequest.purchaseType) &&
        Objects.equals(this.sequenceNumber, cardCreateLodgedCardRequest.sequenceNumber) &&
        Objects.equals(this.orderNumber, cardCreateLodgedCardRequest.orderNumber) &&
        Objects.equals(this.supplierId, cardCreateLodgedCardRequest.supplierId) &&
        Objects.equals(this.nonDomesticSupplier, cardCreateLodgedCardRequest.nonDomesticSupplier) &&
        Objects.equals(this.transmission, cardCreateLodgedCardRequest.transmission) &&
        Objects.equals(this.returnCardData, cardCreateLodgedCardRequest.returnCardData) &&
        Objects.equals(this.customerID, cardCreateLodgedCardRequest.customerID) &&
        Objects.equals(this.associationId, cardCreateLodgedCardRequest.associationId) &&
        Objects.equals(this.labelIDs, cardCreateLodgedCardRequest.labelIDs) &&
        Objects.equals(this.customParameters, cardCreateLodgedCardRequest.customParameters)&&
        Objects.equals(this.additionalProperties, cardCreateLodgedCardRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(merchantGuid, firstName, lastName, phone, address1, address2, city, state, zipCode, country, usageLimit, amountLimit, limitWindow, expirationDate, terminateDate, purchaseType, sequenceNumber, orderNumber, supplierId, nonDomesticSupplier, transmission, returnCardData, customerID, associationId, labelIDs, customParameters, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CardCreateLodgedCardRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("LimitWindow");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardCreateLodgedCardRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardCreateLodgedCardRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardCreateLodgedCardRequest is not found in the empty JSON string", CardCreateLodgedCardRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CardCreateLodgedCardRequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("LimitWindow").isJsonPrimitive()) {
      ...
      if (jsonObj.get("Transmission") != null && !jsonObj.get("Transmission").isJsonNull()) {
        CardCreateLodgedCardRequestTransmission.validateJsonObject(jsonObj.getAsJsonObject("Transmission"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardCreateLodgedCardRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardCreateLodgedCardRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardCreateLodgedCardRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardCreateLodgedCardRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CardCreateLodgedCardRequest>() {
           @Override
           public void write(JsonWriter out, CardCreateLodgedCardRequest value) throws IOException {
           ...
           @Override
           public CardCreateLodgedCardRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CardCreateLodgedCardRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CardCreateLodgedCardRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CardCreateLodgedCardRequest
  * @throws IOException if the JSON string is invalid with respect to CardCreateLodgedCardRequest
  */
  public static CardCreateLodgedCardRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardCreateLodgedCardRequest.class);
  }

 /**
  * Convert an instance of CardCreateLodgedCardRequest to an JSON string
  *
  * @return JSON string
  */
