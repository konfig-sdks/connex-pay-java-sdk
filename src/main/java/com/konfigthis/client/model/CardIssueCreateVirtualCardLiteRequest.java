...
public class CardIssueCreateVirtualCardLiteRequest {
  ...
  private String address1 = "123 Test Street";

  public static final String SERIALIZED_NAME_ADDRESS2 = "Address2";
  @SerializedName(SERIALIZED_NAME_ADDRESS2)
  private String address2 = "Suite 185";

  public static final String SERIALIZED_NAME_CITY = "City";
  @SerializedName(SERIALIZED_NAME_CITY)
  private String city = "Alpharetta";
  ...
  private Float amountLimit = 100f;
  ...
  private String purchaseType = "01";
  ...
  private String orderNumber = "1234A";
  ...
  private CardIssueCreateVirtualCardLiteRequestTransmission transmission;
  ...
  private String associationId = "1234";
  ...
  public CardIssueCreateVirtualCardLiteRequest() {
  }

  public CardIssueCreateVirtualCardLiteRequest merchantGuid(String merchantGuid) {
  ...
  **/
  ...
  @ApiModelProperty(example = "MerchantGuid", required = true, value = "Merchant's guid. Application level value that indicates a virtual card is being requested for clients account. Value provided by ConnexPay.")
  ...
  public CardIssueCreateVirtualCardLiteRequest firstName(String firstName) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Jane", required = true, value = "Cardholder's first name. This is the first name placed on the virtual card provided to the supplier. The value is also searchable in the ConnexPay portal.")
  ...
  public CardIssueCreateVirtualCardLiteRequest lastName(String lastName) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Doe", required = true, value = "Cardholder's last name. This is the last name placed on the virtual card provided to the supplier. The value is also searchable in the ConnexPay portal.")
  ...
  public CardIssueCreateVirtualCardLiteRequest phone(String phone) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1234567890", value = "Cardholder's phone number.  Phone number up to 20 character string, numbers and plus sign (+) allowed only. Telephone number of the user (including area code), prepended by the + symbol and the 1- to 3-digit country calling code. Do not include hyphens, spaces, or parentheses.")
  ...
  public CardIssueCreateVirtualCardLiteRequest address1(String address1) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123 Test Street", value = "Cardholder's address line 1. The street number is used by the supplier when submitting the transaction to perform an AVS check. Alphanumerics and [,.-'] are allowed.")
  ...
  public CardIssueCreateVirtualCardLiteRequest address2(String address2) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Suite 185", value = "Cardholder's address line 2. Alphanumerics and [,.-'] are allowed.")
  ...
  public CardIssueCreateVirtualCardLiteRequest city(String city) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Alpharetta", value = "Cardholder's city.")
  ...
  public CardIssueCreateVirtualCardLiteRequest state(String state) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "GA", value = "Cardholder's short name state.  The ISO 3166-2 CA and US state or province code of a user. Length = 2. If a non U.S. or Canadian value is submitted the virtual card request will not be processed and an error response returned.")
  ...
  public CardIssueCreateVirtualCardLiteRequest zipCode(String zipCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "30004", value = "Cardholder's zipcode. The zip code is used by the supplier when submitting the transaction to perform an AVS check.  The Zipcode must be between 1 and 10 characters long, only numbers and letters are allowed.")
  ...
  public CardIssueCreateVirtualCardLiteRequest country(String country) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "US", value = "Cardholder's country.  Only alpha-2 digit country code allowed and numbers are not allowed.  See ISO-3166 country list of Alpha-2 country codes (https://www.iso.org/obp/ui/) .")
  ...
  public CardIssueCreateVirtualCardLiteRequest usageLimit(Long usageLimit) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequest amountLimit(Float amountLimit) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "100", required = true, value = "Security Control: Maximum dollar amount the card can be authorized and settled, which must be less than or equal to $1,000,000.00. The value must incorporate any anticipated overages such as currency conversion or taxes that a supplier may associate with the transaction. If a supplier attempts to authorize a card for more than the amount limit it will be declined.")
  ...
  public CardIssueCreateVirtualCardLiteRequest expirationDate(LocalDate expirationDate) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequest terminateDate(LocalDate terminateDate) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequest purchaseType(String purchaseType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "01", required = true, value = "Security Control: The industry where the virtual card will be utilized. For example, if value set to airline and the card is used at hotel, it will be declined. Available purchase type values are: '01' (Airline), '02' (Hotels and Resorts), '03' (Car Rental), '04' (Cable, Satellite, Television, and Radio Services),  '05' (Cruise Lines), '11' (Medical Services and Health Practitioners), '21' (Advertising Services), '22' (Misc Advertising and Business Services), '23' (Ticketing), '31' (Insurance Sales, Underwriting, and Premiums), '91' (Restaurants and Food Services), and '93' (Tax Payments). Leave this blank if you plan to utilize MID level controls.")
  ...
  public CardIssueCreateVirtualCardLiteRequest miDWhitelist(List<String> miDWhitelist) {
  ...
  public CardIssueCreateVirtualCardLiteRequest addMiDWhitelistItem(String miDWhitelistItem) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequest miDBlacklist(List<String> miDBlacklist) {
  ...
  public CardIssueCreateVirtualCardLiteRequest addMiDBlacklistItem(String miDBlacklistItem) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequest sequenceNumber(String sequenceNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "987654321", value = "Transaction sequence number within client environment. Provide a unique SequenceNumber for each new request. If a card request is made with all the same parameter information and the same sequence number, within 30 minutes, the request will be considered a duplicate and a new card will not be issued.  Note: value is not searchable or reportable in Bridge.  Alphanumeric.")
  ...
  public CardIssueCreateVirtualCardLiteRequest supplierId(String supplierId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DL", value = "The SupplierId is used to assist with Intelligent Routing functionality. The field accepts up to 100 alpha-numeric characters.  Alphanumeric with a max length of 100 characters")
  ...
  public CardIssueCreateVirtualCardLiteRequest nonDomesticSupplier(Boolean nonDomesticSupplier) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequest orderNumber(String orderNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1234A", value = "This is the most common number you'll see throughout the ConnexPay Portal.  Transaction ID within client environment associated with the order. The value is searchable and reportable in the ConnexPay portal. This value may be sent in multiple instances of the integration for multiple purposes. Customers in the travel space often send the Record Locator/PNR in this field.  The maximum length is 50 alpha-numeric characters and allows dashes and spaces  (\"-\", \" \").")
  ...
  public CardIssueCreateVirtualCardLiteRequest customerID(String customerID) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequest transmission(CardIssueCreateVirtualCardLiteRequestTransmission transmission) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission getTransmission() {
    return transmission;
  }


  public void setTransmission(CardIssueCreateVirtualCardLiteRequestTransmission transmission) {
  ...
  public CardIssueCreateVirtualCardLiteRequest returnCardData(Boolean returnCardData) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequest customParameters(List<CardIssuanceCreateVirtualCardRequestCustomParametersInner> customParameters) {
  ...
  public CardIssueCreateVirtualCardLiteRequest addCustomParametersItem(CardIssuanceCreateVirtualCardRequestCustomParametersInner customParametersItem) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequest activationDate(LocalDate activationDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Future date that the card should be fully funded, at least one day from creation date and within 600 days. If no activation date is supplied the card will be funded immediately.")
  ...
  public CardIssueCreateVirtualCardLiteRequest associationId(String associationId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1234", value = "Utilize the Association ID field to tie a virtual card to a sale or sales. For example, if you have several sales and one virtual card payment to a supplier, you can add association ID to the sales and the virtual card for downstream reporting.")
  ...
  public CardIssueCreateVirtualCardLiteRequest labelIDs(List<String> labelIDs) {
  ...
  public CardIssueCreateVirtualCardLiteRequest addLabelIDsItem(String labelIDsItem) {
  ...
  **/
   ...
   * @return the CardIssueCreateVirtualCardLiteRequest instance itself
   */
  public CardIssueCreateVirtualCardLiteRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CardIssueCreateVirtualCardLiteRequest cardIssueCreateVirtualCardLiteRequest = (CardIssueCreateVirtualCardLiteRequest) o;
    return Objects.equals(this.merchantGuid, cardIssueCreateVirtualCardLiteRequest.merchantGuid) &&
        Objects.equals(this.firstName, cardIssueCreateVirtualCardLiteRequest.firstName) &&
        Objects.equals(this.lastName, cardIssueCreateVirtualCardLiteRequest.lastName) &&
        Objects.equals(this.phone, cardIssueCreateVirtualCardLiteRequest.phone) &&
        Objects.equals(this.address1, cardIssueCreateVirtualCardLiteRequest.address1) &&
        Objects.equals(this.address2, cardIssueCreateVirtualCardLiteRequest.address2) &&
        Objects.equals(this.city, cardIssueCreateVirtualCardLiteRequest.city) &&
        Objects.equals(this.state, cardIssueCreateVirtualCardLiteRequest.state) &&
        Objects.equals(this.zipCode, cardIssueCreateVirtualCardLiteRequest.zipCode) &&
        Objects.equals(this.country, cardIssueCreateVirtualCardLiteRequest.country) &&
        Objects.equals(this.usageLimit, cardIssueCreateVirtualCardLiteRequest.usageLimit) &&
        Objects.equals(this.amountLimit, cardIssueCreateVirtualCardLiteRequest.amountLimit) &&
        Objects.equals(this.expirationDate, cardIssueCreateVirtualCardLiteRequest.expirationDate) &&
        Objects.equals(this.terminateDate, cardIssueCreateVirtualCardLiteRequest.terminateDate) &&
        Objects.equals(this.purchaseType, cardIssueCreateVirtualCardLiteRequest.purchaseType) &&
        Objects.equals(this.miDWhitelist, cardIssueCreateVirtualCardLiteRequest.miDWhitelist) &&
        Objects.equals(this.miDBlacklist, cardIssueCreateVirtualCardLiteRequest.miDBlacklist) &&
        Objects.equals(this.sequenceNumber, cardIssueCreateVirtualCardLiteRequest.sequenceNumber) &&
        Objects.equals(this.supplierId, cardIssueCreateVirtualCardLiteRequest.supplierId) &&
        Objects.equals(this.nonDomesticSupplier, cardIssueCreateVirtualCardLiteRequest.nonDomesticSupplier) &&
        Objects.equals(this.orderNumber, cardIssueCreateVirtualCardLiteRequest.orderNumber) &&
        Objects.equals(this.customerID, cardIssueCreateVirtualCardLiteRequest.customerID) &&
        Objects.equals(this.transmission, cardIssueCreateVirtualCardLiteRequest.transmission) &&
        Objects.equals(this.returnCardData, cardIssueCreateVirtualCardLiteRequest.returnCardData) &&
        Objects.equals(this.customParameters, cardIssueCreateVirtualCardLiteRequest.customParameters) &&
        Objects.equals(this.activationDate, cardIssueCreateVirtualCardLiteRequest.activationDate) &&
        Objects.equals(this.associationId, cardIssueCreateVirtualCardLiteRequest.associationId) &&
        Objects.equals(this.labelIDs, cardIssueCreateVirtualCardLiteRequest.labelIDs)&&
        Objects.equals(this.additionalProperties, cardIssueCreateVirtualCardLiteRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(merchantGuid, firstName, lastName, phone, address1, address2, city, state, zipCode, country, usageLimit, amountLimit, expirationDate, terminateDate, purchaseType, miDWhitelist, miDBlacklist, sequenceNumber, supplierId, nonDomesticSupplier, orderNumber, customerID, transmission, returnCardData, customParameters, activationDate, associationId, labelIDs, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CardIssueCreateVirtualCardLiteRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardIssueCreateVirtualCardLiteRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardIssueCreateVirtualCardLiteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardIssueCreateVirtualCardLiteRequest is not found in the empty JSON string", CardIssueCreateVirtualCardLiteRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CardIssueCreateVirtualCardLiteRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("Transmission") != null && !jsonObj.get("Transmission").isJsonNull()) {
        CardIssueCreateVirtualCardLiteRequestTransmission.validateJsonObject(jsonObj.getAsJsonObject("Transmission"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardIssueCreateVirtualCardLiteRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardIssueCreateVirtualCardLiteRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardIssueCreateVirtualCardLiteRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardIssueCreateVirtualCardLiteRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CardIssueCreateVirtualCardLiteRequest>() {
           @Override
           public void write(JsonWriter out, CardIssueCreateVirtualCardLiteRequest value) throws IOException {
           ...
           @Override
           public CardIssueCreateVirtualCardLiteRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CardIssueCreateVirtualCardLiteRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CardIssueCreateVirtualCardLiteRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CardIssueCreateVirtualCardLiteRequest
  * @throws IOException if the JSON string is invalid with respect to CardIssueCreateVirtualCardLiteRequest
  */
  public static CardIssueCreateVirtualCardLiteRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardIssueCreateVirtualCardLiteRequest.class);
  }

 /**
  * Convert an instance of CardIssueCreateVirtualCardLiteRequest to an JSON string
  *
  * @return JSON string
  */
