...
public class AchCreateCreditPaymentResponse {
  ...
  public AchCreateCreditPaymentResponse() {
  }

  public AchCreateCreditPaymentResponse description(String description) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse merchantId(String merchantId) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse incomingTransactionCode(String incomingTransactionCode) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse paymentId(String paymentId) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse isCredit(Boolean isCredit) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse amount(Integer amount) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse payeeName(String payeeName) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse paymentStatus(String paymentStatus) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse scheduleDate(String scheduleDate) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse receiptDate(String receiptDate) {
  ...
  **/
  ...
  public AchCreateCreditPaymentResponse processingDate(Object processingDate) {
  ...
  **/
   ...
   * @return the AchCreateCreditPaymentResponse instance itself
   */
  public AchCreateCreditPaymentResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AchCreateCreditPaymentResponse achCreateCreditPaymentResponse = (AchCreateCreditPaymentResponse) o;
    return Objects.equals(this.description, achCreateCreditPaymentResponse.description) &&
        Objects.equals(this.merchantId, achCreateCreditPaymentResponse.merchantId) &&
        Objects.equals(this.incomingTransactionCode, achCreateCreditPaymentResponse.incomingTransactionCode) &&
        Objects.equals(this.paymentId, achCreateCreditPaymentResponse.paymentId) &&
        Objects.equals(this.isCredit, achCreateCreditPaymentResponse.isCredit) &&
        Objects.equals(this.amount, achCreateCreditPaymentResponse.amount) &&
        Objects.equals(this.payeeName, achCreateCreditPaymentResponse.payeeName) &&
        Objects.equals(this.paymentStatus, achCreateCreditPaymentResponse.paymentStatus) &&
        Objects.equals(this.scheduleDate, achCreateCreditPaymentResponse.scheduleDate) &&
        Objects.equals(this.receiptDate, achCreateCreditPaymentResponse.receiptDate) &&
        Objects.equals(this.processingDate, achCreateCreditPaymentResponse.processingDate)&&
        Objects.equals(this.additionalProperties, achCreateCreditPaymentResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AchCreateCreditPaymentResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AchCreateCreditPaymentResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AchCreateCreditPaymentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AchCreateCreditPaymentResponse is not found in the empty JSON string", AchCreateCreditPaymentResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AchCreateCreditPaymentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AchCreateCreditPaymentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AchCreateCreditPaymentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AchCreateCreditPaymentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AchCreateCreditPaymentResponse>() {
           @Override
           public void write(JsonWriter out, AchCreateCreditPaymentResponse value) throws IOException {
           ...
           @Override
           public AchCreateCreditPaymentResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AchCreateCreditPaymentResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AchCreateCreditPaymentResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AchCreateCreditPaymentResponse
  * @throws IOException if the JSON string is invalid with respect to AchCreateCreditPaymentResponse
  */
  public static AchCreateCreditPaymentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AchCreateCreditPaymentResponse.class);
  }

 /**
  * Convert an instance of AchCreateCreditPaymentResponse to an JSON string
  *
  * @return JSON string
  */
