...
public class SaleCreateTransactionRequestBankAccountCustomer {
  ...
  public SaleCreateTransactionRequestBankAccountCustomer() {
  }

  public SaleCreateTransactionRequestBankAccountCustomer firstName(String firstName) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer lastName(String lastName) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer phone(String phone) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer city(String city) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer state(String state) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer country(String country) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer email(String email) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer address1(String address1) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer address2(String address2) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer zip(String zip) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer dateOfBirth(LocalDate dateOfBirth) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer driversLicenseNumber(Integer driversLicenseNumber) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer driversLicenseState(String driversLicenseState) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestBankAccountCustomer SSN4(Integer SSN4) {
  ...
  **/
   ...
   * @return the SaleCreateTransactionRequestBankAccountCustomer instance itself
   */
  public SaleCreateTransactionRequestBankAccountCustomer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SaleCreateTransactionRequestBankAccountCustomer saleCreateTransactionRequestBankAccountCustomer = (SaleCreateTransactionRequestBankAccountCustomer) o;
    return Objects.equals(this.firstName, saleCreateTransactionRequestBankAccountCustomer.firstName) &&
        Objects.equals(this.lastName, saleCreateTransactionRequestBankAccountCustomer.lastName) &&
        Objects.equals(this.phone, saleCreateTransactionRequestBankAccountCustomer.phone) &&
        Objects.equals(this.city, saleCreateTransactionRequestBankAccountCustomer.city) &&
        Objects.equals(this.state, saleCreateTransactionRequestBankAccountCustomer.state) &&
        Objects.equals(this.country, saleCreateTransactionRequestBankAccountCustomer.country) &&
        Objects.equals(this.email, saleCreateTransactionRequestBankAccountCustomer.email) &&
        Objects.equals(this.address1, saleCreateTransactionRequestBankAccountCustomer.address1) &&
        Objects.equals(this.address2, saleCreateTransactionRequestBankAccountCustomer.address2) &&
        Objects.equals(this.zip, saleCreateTransactionRequestBankAccountCustomer.zip) &&
        Objects.equals(this.dateOfBirth, saleCreateTransactionRequestBankAccountCustomer.dateOfBirth) &&
        Objects.equals(this.driversLicenseNumber, saleCreateTransactionRequestBankAccountCustomer.driversLicenseNumber) &&
        Objects.equals(this.driversLicenseState, saleCreateTransactionRequestBankAccountCustomer.driversLicenseState) &&
        Objects.equals(this.SSN4, saleCreateTransactionRequestBankAccountCustomer.SSN4)&&
        Objects.equals(this.additionalProperties, saleCreateTransactionRequestBankAccountCustomer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SaleCreateTransactionRequestBankAccountCustomer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SaleCreateTransactionRequestBankAccountCustomer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SaleCreateTransactionRequestBankAccountCustomer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SaleCreateTransactionRequestBankAccountCustomer is not found in the empty JSON string", SaleCreateTransactionRequestBankAccountCustomer.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SaleCreateTransactionRequestBankAccountCustomer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SaleCreateTransactionRequestBankAccountCustomer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SaleCreateTransactionRequestBankAccountCustomer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SaleCreateTransactionRequestBankAccountCustomer.class));

       return (TypeAdapter<T>) new TypeAdapter<SaleCreateTransactionRequestBankAccountCustomer>() {
           @Override
           public void write(JsonWriter out, SaleCreateTransactionRequestBankAccountCustomer value) throws IOException {
           ...
           @Override
           public SaleCreateTransactionRequestBankAccountCustomer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SaleCreateTransactionRequestBankAccountCustomer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SaleCreateTransactionRequestBankAccountCustomer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SaleCreateTransactionRequestBankAccountCustomer
  * @throws IOException if the JSON string is invalid with respect to SaleCreateTransactionRequestBankAccountCustomer
  */
  public static SaleCreateTransactionRequestBankAccountCustomer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SaleCreateTransactionRequestBankAccountCustomer.class);
  }

 /**
  * Convert an instance of SaleCreateTransactionRequestBankAccountCustomer to an JSON string
  *
  * @return JSON string
  */
