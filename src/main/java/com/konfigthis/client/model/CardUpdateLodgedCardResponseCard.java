...
public class CardUpdateLodgedCardResponseCard {
  ...
  public CardUpdateLodgedCardResponseCard() {
  }

  public CardUpdateLodgedCardResponseCard cardGuid(String cardGuid) {
  ...
  **/
  ...
  @ApiModelProperty(example = "0de2e407-5509-40c0-8b59-44e1b2b81f23", value = "")
  ...
  public CardUpdateLodgedCardResponseCard amountLimit(Integer amountLimit) {
  ...
  **/
  ...
  public CardUpdateLodgedCardResponseCard usageLimit(Integer usageLimit) {
  ...
  **/
  ...
  public CardUpdateLodgedCardResponseCard limitWindow(String limitWindow) {
  ...
  **/
  ...
  public CardUpdateLodgedCardResponseCard expirationDate(String expirationDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2021-12-30T23:59:59", value = "")
  ...
  public CardUpdateLodgedCardResponseCard expiration(String expiration) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1221", value = "")
  ...
  public CardUpdateLodgedCardResponseCard firstSix(String firstSix) {
  ...
  **/
  ...
  public CardUpdateLodgedCardResponseCard lastFour(String lastFour) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0033", value = "")
  ...
  public CardUpdateLodgedCardResponseCard nameLine1(String nameLine1) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Monim", value = "")
  ...
  public CardUpdateLodgedCardResponseCard nameLine2(String nameLine2) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Lodged", value = "")
  ...
  public CardUpdateLodgedCardResponseCard status(String status) {
  ...
  **/
  ...
  public CardUpdateLodgedCardResponseCard cardType(String cardType) {
  ...
  **/
  ...
  public CardUpdateLodgedCardResponseCard midWhitelist(List<String> midWhitelist) {
  ...
  public CardUpdateLodgedCardResponseCard addMidWhitelistItem(String midWhitelistItem) {
  ...
  **/
  ...
  public CardUpdateLodgedCardResponseCard midBlacklist(List<String> midBlacklist) {
  ...
  public CardUpdateLodgedCardResponseCard addMidBlacklistItem(String midBlacklistItem) {
  ...
  **/
   ...
   * @return the CardUpdateLodgedCardResponseCard instance itself
   */
  public CardUpdateLodgedCardResponseCard putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CardUpdateLodgedCardResponseCard cardUpdateLodgedCardResponseCard = (CardUpdateLodgedCardResponseCard) o;
    return Objects.equals(this.cardGuid, cardUpdateLodgedCardResponseCard.cardGuid) &&
        Objects.equals(this.amountLimit, cardUpdateLodgedCardResponseCard.amountLimit) &&
        Objects.equals(this.usageLimit, cardUpdateLodgedCardResponseCard.usageLimit) &&
        Objects.equals(this.limitWindow, cardUpdateLodgedCardResponseCard.limitWindow) &&
        Objects.equals(this.expirationDate, cardUpdateLodgedCardResponseCard.expirationDate) &&
        Objects.equals(this.expiration, cardUpdateLodgedCardResponseCard.expiration) &&
        Objects.equals(this.firstSix, cardUpdateLodgedCardResponseCard.firstSix) &&
        Objects.equals(this.lastFour, cardUpdateLodgedCardResponseCard.lastFour) &&
        Objects.equals(this.nameLine1, cardUpdateLodgedCardResponseCard.nameLine1) &&
        Objects.equals(this.nameLine2, cardUpdateLodgedCardResponseCard.nameLine2) &&
        Objects.equals(this.status, cardUpdateLodgedCardResponseCard.status) &&
        Objects.equals(this.cardType, cardUpdateLodgedCardResponseCard.cardType) &&
        Objects.equals(this.midWhitelist, cardUpdateLodgedCardResponseCard.midWhitelist) &&
        Objects.equals(this.midBlacklist, cardUpdateLodgedCardResponseCard.midBlacklist)&&
        Objects.equals(this.additionalProperties, cardUpdateLodgedCardResponseCard.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardGuid, amountLimit, usageLimit, limitWindow, expirationDate, expiration, firstSix, lastFour, nameLine1, nameLine2, status, cardType, midWhitelist, midBlacklist, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CardUpdateLodgedCardResponseCard {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardUpdateLodgedCardResponseCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardUpdateLodgedCardResponseCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardUpdateLodgedCardResponseCard is not found in the empty JSON string", CardUpdateLodgedCardResponseCard.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardUpdateLodgedCardResponseCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardUpdateLodgedCardResponseCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardUpdateLodgedCardResponseCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardUpdateLodgedCardResponseCard.class));

       return (TypeAdapter<T>) new TypeAdapter<CardUpdateLodgedCardResponseCard>() {
           @Override
           public void write(JsonWriter out, CardUpdateLodgedCardResponseCard value) throws IOException {
           ...
           @Override
           public CardUpdateLodgedCardResponseCard read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CardUpdateLodgedCardResponseCard instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CardUpdateLodgedCardResponseCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CardUpdateLodgedCardResponseCard
  * @throws IOException if the JSON string is invalid with respect to CardUpdateLodgedCardResponseCard
  */
  public static CardUpdateLodgedCardResponseCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardUpdateLodgedCardResponseCard.class);
  }

 /**
  * Convert an instance of CardUpdateLodgedCardResponseCard to an JSON string
  *
  * @return JSON string
  */
