 ...
 */
@ApiModel(description = "URL Links (email) or a text document (fax) to virtual cards can be emailed/faxed by including the VCC Transmission object in the IssueLite API call. Including the transmission object for email also allows you to pull back a URL you can use within your application to direct a user to a visual representation of the virtual card.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CardIssueCreateVirtualCardLiteRequestTransmission {
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission() {
  }

  public CardIssueCreateVirtualCardLiteRequestTransmission transmissionMethods(List<String> transmissionMethods) {
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission addTransmissionMethodsItem(String transmissionMethodsItem) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission emailRecipient(String emailRecipient) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission merchantPhoneNumber(String merchantPhoneNumber) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission emailFrom(String emailFrom) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission recipientName(String recipientName) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission subject(String subject) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission message(String message) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission daysToExpire(String daysToExpire) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission faxFrom(String faxFrom) {
  ...
  **/
  ...
  public CardIssueCreateVirtualCardLiteRequestTransmission faxRecipient(String faxRecipient) {
  ...
  **/
   ...
   * @return the CardIssueCreateVirtualCardLiteRequestTransmission instance itself
   */
  public CardIssueCreateVirtualCardLiteRequestTransmission putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CardIssueCreateVirtualCardLiteRequestTransmission cardIssueCreateVirtualCardLiteRequestTransmission = (CardIssueCreateVirtualCardLiteRequestTransmission) o;
    return Objects.equals(this.transmissionMethods, cardIssueCreateVirtualCardLiteRequestTransmission.transmissionMethods) &&
        Objects.equals(this.emailRecipient, cardIssueCreateVirtualCardLiteRequestTransmission.emailRecipient) &&
        Objects.equals(this.merchantPhoneNumber, cardIssueCreateVirtualCardLiteRequestTransmission.merchantPhoneNumber) &&
        Objects.equals(this.emailFrom, cardIssueCreateVirtualCardLiteRequestTransmission.emailFrom) &&
        Objects.equals(this.recipientName, cardIssueCreateVirtualCardLiteRequestTransmission.recipientName) &&
        Objects.equals(this.subject, cardIssueCreateVirtualCardLiteRequestTransmission.subject) &&
        Objects.equals(this.message, cardIssueCreateVirtualCardLiteRequestTransmission.message) &&
        Objects.equals(this.daysToExpire, cardIssueCreateVirtualCardLiteRequestTransmission.daysToExpire) &&
        Objects.equals(this.faxFrom, cardIssueCreateVirtualCardLiteRequestTransmission.faxFrom) &&
        Objects.equals(this.faxRecipient, cardIssueCreateVirtualCardLiteRequestTransmission.faxRecipient)&&
        Objects.equals(this.additionalProperties, cardIssueCreateVirtualCardLiteRequestTransmission.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CardIssueCreateVirtualCardLiteRequestTransmission {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardIssueCreateVirtualCardLiteRequestTransmission
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardIssueCreateVirtualCardLiteRequestTransmission.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardIssueCreateVirtualCardLiteRequestTransmission is not found in the empty JSON string", CardIssueCreateVirtualCardLiteRequestTransmission.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardIssueCreateVirtualCardLiteRequestTransmission.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardIssueCreateVirtualCardLiteRequestTransmission' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardIssueCreateVirtualCardLiteRequestTransmission> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardIssueCreateVirtualCardLiteRequestTransmission.class));

       return (TypeAdapter<T>) new TypeAdapter<CardIssueCreateVirtualCardLiteRequestTransmission>() {
           @Override
           public void write(JsonWriter out, CardIssueCreateVirtualCardLiteRequestTransmission value) throws IOException {
           ...
           @Override
           public CardIssueCreateVirtualCardLiteRequestTransmission read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CardIssueCreateVirtualCardLiteRequestTransmission instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CardIssueCreateVirtualCardLiteRequestTransmission given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CardIssueCreateVirtualCardLiteRequestTransmission
  * @throws IOException if the JSON string is invalid with respect to CardIssueCreateVirtualCardLiteRequestTransmission
  */
  public static CardIssueCreateVirtualCardLiteRequestTransmission fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardIssueCreateVirtualCardLiteRequestTransmission.class);
  }

 /**
  * Convert an instance of CardIssueCreateVirtualCardLiteRequestTransmission to an JSON string
  *
  * @return JSON string
  */
