...
import com.konfigthis.client.model.ReturnItemRequestResponseSale;
...
public class ReturnItemRequestResponse {
  ...
  private ReturnItemRequestResponseSale sale;

  public ReturnItemRequestResponse() {
  }

  public ReturnItemRequestResponse guid(String guid) {
  ...
  **/
  ...
  @ApiModelProperty(example = "4f31b350-edd1-49fd-a1ad-4b065f78d7b9", value = "")
  ...
  public ReturnItemRequestResponse batchStatus(String batchStatus) {
  ...
  **/
  ...
  public ReturnItemRequestResponse timeStamp(String timeStamp) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2017-07-11T11:10:38.11", value = "")
  ...
  public ReturnItemRequestResponse deviceGuid(String deviceGuid) {
  ...
  **/
  ...
  public ReturnItemRequestResponse saleGuid(String saleGuid) {
  ...
  **/
  ...
  public ReturnItemRequestResponse status(String status) {
  ...
  **/
  ...
  public ReturnItemRequestResponse amount(Double amount) {
  ...
  public ReturnItemRequestResponse amount(Integer amount) {
  ...
  **/
  ...
  public ReturnItemRequestResponse batchGuid(String batchGuid) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "450463e0-5050-4c33-8c2f-4e39a2dd8614", value = "")
  ...
  public ReturnItemRequestResponse processorStatusCode(String processorStatusCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "A0014", value = "")
  ...
  public ReturnItemRequestResponse wasProcessed(Boolean wasProcessed) {
  ...
  **/
  ...
  public ReturnItemRequestResponse authCode(String authCode) {
  ...
  **/
  ...
  public ReturnItemRequestResponse refNumber(String refNumber) {
  ...
  **/
  ...
  public ReturnItemRequestResponse invoiceNumber(String invoiceNumber) {
  ...
  **/
  ...
  public ReturnItemRequestResponse customerReceipt(String customerReceipt) {
  ...
  **/
  ...
  public ReturnItemRequestResponse sequenceNumber(String sequenceNumber) {
  ...
  **/
  ...
  public ReturnItemRequestResponse sale(ReturnItemRequestResponseSale sale) {
  ...
  **/
  ...
  public ReturnItemRequestResponseSale getSale() {
    return sale;
  }


  public void setSale(ReturnItemRequestResponseSale sale) {
   ...
   * @return the ReturnItemRequestResponse instance itself
   */
  public ReturnItemRequestResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReturnItemRequestResponse returnItemRequestResponse = (ReturnItemRequestResponse) o;
    return Objects.equals(this.guid, returnItemRequestResponse.guid) &&
        Objects.equals(this.batchStatus, returnItemRequestResponse.batchStatus) &&
        Objects.equals(this.timeStamp, returnItemRequestResponse.timeStamp) &&
        Objects.equals(this.deviceGuid, returnItemRequestResponse.deviceGuid) &&
        Objects.equals(this.saleGuid, returnItemRequestResponse.saleGuid) &&
        Objects.equals(this.status, returnItemRequestResponse.status) &&
        Objects.equals(this.amount, returnItemRequestResponse.amount) &&
        Objects.equals(this.batchGuid, returnItemRequestResponse.batchGuid) &&
        Objects.equals(this.processorStatusCode, returnItemRequestResponse.processorStatusCode) &&
        Objects.equals(this.wasProcessed, returnItemRequestResponse.wasProcessed) &&
        Objects.equals(this.authCode, returnItemRequestResponse.authCode) &&
        Objects.equals(this.refNumber, returnItemRequestResponse.refNumber) &&
        Objects.equals(this.invoiceNumber, returnItemRequestResponse.invoiceNumber) &&
        Objects.equals(this.customerReceipt, returnItemRequestResponse.customerReceipt) &&
        Objects.equals(this.sequenceNumber, returnItemRequestResponse.sequenceNumber) &&
        Objects.equals(this.sale, returnItemRequestResponse.sale)&&
        Objects.equals(this.additionalProperties, returnItemRequestResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(guid, batchStatus, timeStamp, deviceGuid, saleGuid, status, amount, batchGuid, processorStatusCode, wasProcessed, authCode, refNumber, invoiceNumber, customerReceipt, sequenceNumber, sale, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReturnItemRequestResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReturnItemRequestResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReturnItemRequestResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReturnItemRequestResponse is not found in the empty JSON string", ReturnItemRequestResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("sale") != null && !jsonObj.get("sale").isJsonNull()) {
        ReturnItemRequestResponseSale.validateJsonObject(jsonObj.getAsJsonObject("sale"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReturnItemRequestResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReturnItemRequestResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReturnItemRequestResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReturnItemRequestResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ReturnItemRequestResponse>() {
           @Override
           public void write(JsonWriter out, ReturnItemRequestResponse value) throws IOException {
           ...
           @Override
           public ReturnItemRequestResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReturnItemRequestResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReturnItemRequestResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReturnItemRequestResponse
  * @throws IOException if the JSON string is invalid with respect to ReturnItemRequestResponse
  */
  public static ReturnItemRequestResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReturnItemRequestResponse.class);
  }

 /**
  * Convert an instance of ReturnItemRequestResponse to an JSON string
  *
  * @return JSON string
  */
