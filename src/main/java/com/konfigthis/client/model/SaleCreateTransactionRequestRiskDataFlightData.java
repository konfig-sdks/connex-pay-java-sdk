...
public class SaleCreateTransactionRequestRiskDataFlightData {
  ...
  public SaleCreateTransactionRequestRiskDataFlightData() {
  }

  public SaleCreateTransactionRequestRiskDataFlightData airline(String airline) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskDataFlightData departureAirport(String departureAirport) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskDataFlightData departureDate(String departureDate) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskDataFlightData destinationAirport(String destinationAirport) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskDataFlightData hoursToDeparture(String hoursToDeparture) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskDataFlightData journeyType(String journeyType) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskDataFlightData route(String route) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskDataFlightData routeByCountry(String routeByCountry) {
  ...
  **/
   ...
   * @return the SaleCreateTransactionRequestRiskDataFlightData instance itself
   */
  public SaleCreateTransactionRequestRiskDataFlightData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SaleCreateTransactionRequestRiskDataFlightData saleCreateTransactionRequestRiskDataFlightData = (SaleCreateTransactionRequestRiskDataFlightData) o;
    return Objects.equals(this.airline, saleCreateTransactionRequestRiskDataFlightData.airline) &&
        Objects.equals(this.departureAirport, saleCreateTransactionRequestRiskDataFlightData.departureAirport) &&
        Objects.equals(this.departureDate, saleCreateTransactionRequestRiskDataFlightData.departureDate) &&
        Objects.equals(this.destinationAirport, saleCreateTransactionRequestRiskDataFlightData.destinationAirport) &&
        Objects.equals(this.hoursToDeparture, saleCreateTransactionRequestRiskDataFlightData.hoursToDeparture) &&
        Objects.equals(this.journeyType, saleCreateTransactionRequestRiskDataFlightData.journeyType) &&
        Objects.equals(this.route, saleCreateTransactionRequestRiskDataFlightData.route) &&
        Objects.equals(this.routeByCountry, saleCreateTransactionRequestRiskDataFlightData.routeByCountry)&&
        Objects.equals(this.additionalProperties, saleCreateTransactionRequestRiskDataFlightData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SaleCreateTransactionRequestRiskDataFlightData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SaleCreateTransactionRequestRiskDataFlightData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SaleCreateTransactionRequestRiskDataFlightData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SaleCreateTransactionRequestRiskDataFlightData is not found in the empty JSON string", SaleCreateTransactionRequestRiskDataFlightData.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SaleCreateTransactionRequestRiskDataFlightData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SaleCreateTransactionRequestRiskDataFlightData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SaleCreateTransactionRequestRiskDataFlightData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SaleCreateTransactionRequestRiskDataFlightData.class));

       return (TypeAdapter<T>) new TypeAdapter<SaleCreateTransactionRequestRiskDataFlightData>() {
           @Override
           public void write(JsonWriter out, SaleCreateTransactionRequestRiskDataFlightData value) throws IOException {
           ...
           @Override
           public SaleCreateTransactionRequestRiskDataFlightData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SaleCreateTransactionRequestRiskDataFlightData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SaleCreateTransactionRequestRiskDataFlightData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SaleCreateTransactionRequestRiskDataFlightData
  * @throws IOException if the JSON string is invalid with respect to SaleCreateTransactionRequestRiskDataFlightData
  */
  public static SaleCreateTransactionRequestRiskDataFlightData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SaleCreateTransactionRequestRiskDataFlightData.class);
  }

 /**
  * Convert an instance of SaleCreateTransactionRequestRiskDataFlightData to an JSON string
  *
  * @return JSON string
  */
