...
public class CardCancelVirtualCardResponseCard {
  ...
  public CardCancelVirtualCardResponseCard() {
  }

  public CardCancelVirtualCardResponseCard cardGuid(String cardGuid) {
  ...
  **/
  ...
  @ApiModelProperty(example = "2cf4bdbf-48c1-4e23-9ae3-4d5236a8b917", value = "")
  ...
  public CardCancelVirtualCardResponseCard amountLimit(Double amountLimit) {
  ...
  public CardCancelVirtualCardResponseCard amountLimit(Integer amountLimit) {
    
    
    
    
    this.amountLimit = amountLimit.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "12.07", value = "")
  ...
  public CardCancelVirtualCardResponseCard usageLimit(Integer usageLimit) {
  ...
  **/
  ...
  public CardCancelVirtualCardResponseCard limitWindow(String limitWindow) {
  ...
  **/
  ...
  public CardCancelVirtualCardResponseCard expirationDate(String expirationDate) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2021-11-04T00:00:00", value = "")
  ...
  public CardCancelVirtualCardResponseCard expiration(String expiration) {
  ...
  **/
  ...
  public CardCancelVirtualCardResponseCard firstSix(String firstSix) {
  ...
  **/
  ...
  public CardCancelVirtualCardResponseCard lastFour(String lastFour) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "3349", value = "")
  ...
  public CardCancelVirtualCardResponseCard nameLine1(String nameLine1) {
  ...
  **/
  ...
  public CardCancelVirtualCardResponseCard nameLine2(String nameLine2) {
  ...
  **/
  ...
  public CardCancelVirtualCardResponseCard status(String status) {
  ...
  **/
  ...
  public CardCancelVirtualCardResponseCard cardType(String cardType) {
  ...
  **/
   ...
   * @return the CardCancelVirtualCardResponseCard instance itself
   */
  public CardCancelVirtualCardResponseCard putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CardCancelVirtualCardResponseCard cardCancelVirtualCardResponseCard = (CardCancelVirtualCardResponseCard) o;
    return Objects.equals(this.cardGuid, cardCancelVirtualCardResponseCard.cardGuid) &&
        Objects.equals(this.amountLimit, cardCancelVirtualCardResponseCard.amountLimit) &&
        Objects.equals(this.usageLimit, cardCancelVirtualCardResponseCard.usageLimit) &&
        Objects.equals(this.limitWindow, cardCancelVirtualCardResponseCard.limitWindow) &&
        Objects.equals(this.expirationDate, cardCancelVirtualCardResponseCard.expirationDate) &&
        Objects.equals(this.expiration, cardCancelVirtualCardResponseCard.expiration) &&
        Objects.equals(this.firstSix, cardCancelVirtualCardResponseCard.firstSix) &&
        Objects.equals(this.lastFour, cardCancelVirtualCardResponseCard.lastFour) &&
        Objects.equals(this.nameLine1, cardCancelVirtualCardResponseCard.nameLine1) &&
        Objects.equals(this.nameLine2, cardCancelVirtualCardResponseCard.nameLine2) &&
        Objects.equals(this.status, cardCancelVirtualCardResponseCard.status) &&
        Objects.equals(this.cardType, cardCancelVirtualCardResponseCard.cardType)&&
        Objects.equals(this.additionalProperties, cardCancelVirtualCardResponseCard.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CardCancelVirtualCardResponseCard {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardCancelVirtualCardResponseCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardCancelVirtualCardResponseCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardCancelVirtualCardResponseCard is not found in the empty JSON string", CardCancelVirtualCardResponseCard.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardCancelVirtualCardResponseCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardCancelVirtualCardResponseCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardCancelVirtualCardResponseCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardCancelVirtualCardResponseCard.class));

       return (TypeAdapter<T>) new TypeAdapter<CardCancelVirtualCardResponseCard>() {
           @Override
           public void write(JsonWriter out, CardCancelVirtualCardResponseCard value) throws IOException {
           ...
           @Override
           public CardCancelVirtualCardResponseCard read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CardCancelVirtualCardResponseCard instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CardCancelVirtualCardResponseCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CardCancelVirtualCardResponseCard
  * @throws IOException if the JSON string is invalid with respect to CardCancelVirtualCardResponseCard
  */
  public static CardCancelVirtualCardResponseCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardCancelVirtualCardResponseCard.class);
  }

 /**
  * Convert an instance of CardCancelVirtualCardResponseCard to an JSON string
  *
  * @return JSON string
  */
