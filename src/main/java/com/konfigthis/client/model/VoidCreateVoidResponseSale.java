...
public class VoidCreateVoidResponseSale {
  ...
  private VoidCreateVoidResponseSaleCard card;

  public VoidCreateVoidResponseSale() {
  }

  public VoidCreateVoidResponseSale guid(String guid) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale status(String status) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale batchStatus(String batchStatus) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale timeStamp(String timeStamp) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2017-07-11T11:05:24.65", value = "")
  ...
  public VoidCreateVoidResponseSale deviceGuid(String deviceGuid) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale amount(Double amount) {
  ...
  public VoidCreateVoidResponseSale amount(Integer amount) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale effectiveAmount(Integer effectiveAmount) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale orderNumber(String orderNumber) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale orderDate(String orderDate) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale batchGuid(String batchGuid) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale processorStatusCode(String processorStatusCode) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale processorResponseMessage(String processorResponseMessage) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale wasProcessed(Boolean wasProcessed) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale authCode(String authCode) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale refNumber(String refNumber) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale invoiceNumber(String invoiceNumber) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale customerReceipt(String customerReceipt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SUR TECHNOLOGY HOLDINGS 8320 S HARDY DRIVE TEMPE AZ 85284 07/11/2017 07:05:27  CREDIT - SALE  CARD # : **** **** **** 0213 CARD TYPE :MASTERCARD Entry Mode : MANUAL  REF # : 13283644 Invoice number : 11518 AUTH CODE : VTLMC1 Subtotal:                       $19.74 -------------------------------------- Total:                          $19.74 --------------------------------------    John Doe  CUSTOMER ACKNOWLEDGES RECEIPT OF GOODS AND/OR SERVICES IN THE AMOUNT OF THE TOTAL SHOWN HEREON AND AGREES TO PERFORM THE OBLIGATIONS SET FORTH BY THE CUSTOMER`S AGREEMENT WITH THE ISSUER APPROVED     Customer Copy ", value = "")
  ...
  public VoidCreateVoidResponseSale customData(String customData) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSale card(VoidCreateVoidResponseSaleCard card) {
  ...
  **/
  ...
  public VoidCreateVoidResponseSaleCard getCard() {
    return card;
  }


  public void setCard(VoidCreateVoidResponseSaleCard card) {
   ...
   * @return the VoidCreateVoidResponseSale instance itself
   */
  public VoidCreateVoidResponseSale putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VoidCreateVoidResponseSale voidCreateVoidResponseSale = (VoidCreateVoidResponseSale) o;
    return Objects.equals(this.guid, voidCreateVoidResponseSale.guid) &&
        Objects.equals(this.status, voidCreateVoidResponseSale.status) &&
        Objects.equals(this.batchStatus, voidCreateVoidResponseSale.batchStatus) &&
        Objects.equals(this.timeStamp, voidCreateVoidResponseSale.timeStamp) &&
        Objects.equals(this.deviceGuid, voidCreateVoidResponseSale.deviceGuid) &&
        Objects.equals(this.amount, voidCreateVoidResponseSale.amount) &&
        Objects.equals(this.effectiveAmount, voidCreateVoidResponseSale.effectiveAmount) &&
        Objects.equals(this.orderNumber, voidCreateVoidResponseSale.orderNumber) &&
        Objects.equals(this.orderDate, voidCreateVoidResponseSale.orderDate) &&
        Objects.equals(this.batchGuid, voidCreateVoidResponseSale.batchGuid) &&
        Objects.equals(this.processorStatusCode, voidCreateVoidResponseSale.processorStatusCode) &&
        Objects.equals(this.processorResponseMessage, voidCreateVoidResponseSale.processorResponseMessage) &&
        Objects.equals(this.wasProcessed, voidCreateVoidResponseSale.wasProcessed) &&
        Objects.equals(this.authCode, voidCreateVoidResponseSale.authCode) &&
        Objects.equals(this.refNumber, voidCreateVoidResponseSale.refNumber) &&
        Objects.equals(this.invoiceNumber, voidCreateVoidResponseSale.invoiceNumber) &&
        Objects.equals(this.customerReceipt, voidCreateVoidResponseSale.customerReceipt) &&
        Objects.equals(this.customData, voidCreateVoidResponseSale.customData) &&
        Objects.equals(this.card, voidCreateVoidResponseSale.card)&&
        Objects.equals(this.additionalProperties, voidCreateVoidResponseSale.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VoidCreateVoidResponseSale {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VoidCreateVoidResponseSale
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VoidCreateVoidResponseSale.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VoidCreateVoidResponseSale is not found in the empty JSON string", VoidCreateVoidResponseSale.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("card") != null && !jsonObj.get("card").isJsonNull()) {
        VoidCreateVoidResponseSaleCard.validateJsonObject(jsonObj.getAsJsonObject("card"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VoidCreateVoidResponseSale.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VoidCreateVoidResponseSale' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VoidCreateVoidResponseSale> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VoidCreateVoidResponseSale.class));

       return (TypeAdapter<T>) new TypeAdapter<VoidCreateVoidResponseSale>() {
           @Override
           public void write(JsonWriter out, VoidCreateVoidResponseSale value) throws IOException {
           ...
           @Override
           public VoidCreateVoidResponseSale read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VoidCreateVoidResponseSale instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VoidCreateVoidResponseSale given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VoidCreateVoidResponseSale
  * @throws IOException if the JSON string is invalid with respect to VoidCreateVoidResponseSale
  */
  public static VoidCreateVoidResponseSale fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VoidCreateVoidResponseSale.class);
  }

 /**
  * Convert an instance of VoidCreateVoidResponseSale to an JSON string
  *
  * @return JSON string
  */
