...
public class SaleCreateTransactionRequestRiskData {
  ...
  private SaleCreateTransactionRequestRiskDataFlightData flightData;
  ...
  private List<SaleCreateTransactionRequestRiskDataFlightPassengersInner> flightPassengers = null;
  ...
  public SaleCreateTransactionRequestRiskData() {
  }

  public SaleCreateTransactionRequestRiskData sessionId(String sessionId) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData name(String name) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData gender(String gender) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData dateOfBirth(String dateOfBirth) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData billingPhoneNumber(String billingPhoneNumber) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData billingAddress1(String billingAddress1) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData billingAddress2(String billingAddress2) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData billingCity(String billingCity) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData billingState(String billingState) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData billingPostalCode(String billingPostalCode) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData billingCountryCode(String billingCountryCode) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData email(String email) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData productType(String productType) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData productDescription(String productDescription) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData productItem(String productItem) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData productQuantity(Integer productQuantity) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData productPrice(Integer productPrice) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData orderNumber(String orderNumber) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData sellerId(String sellerId) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskData flightData(SaleCreateTransactionRequestRiskDataFlightData flightData) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestRiskDataFlightData getFlightData() {
    return flightData;
  }


  public void setFlightData(SaleCreateTransactionRequestRiskDataFlightData flightData) {
  ...
  public SaleCreateTransactionRequestRiskData flightPassengers(List<SaleCreateTransactionRequestRiskDataFlightPassengersInner> flightPassengers) {
  ...
  public SaleCreateTransactionRequestRiskData addFlightPassengersItem(SaleCreateTransactionRequestRiskDataFlightPassengersInner flightPassengersItem) {
  ...
  **/
  ...
  public List<SaleCreateTransactionRequestRiskDataFlightPassengersInner> getFlightPassengers() {
    return flightPassengers;
  }


  public void setFlightPassengers(List<SaleCreateTransactionRequestRiskDataFlightPassengersInner> flightPassengers) {
  ...
  public SaleCreateTransactionRequestRiskData customParameters(Object customParameters) {
  ...
  **/
   ...
   * @return the SaleCreateTransactionRequestRiskData instance itself
   */
  public SaleCreateTransactionRequestRiskData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SaleCreateTransactionRequestRiskData saleCreateTransactionRequestRiskData = (SaleCreateTransactionRequestRiskData) o;
    return Objects.equals(this.sessionId, saleCreateTransactionRequestRiskData.sessionId) &&
        Objects.equals(this.name, saleCreateTransactionRequestRiskData.name) &&
        Objects.equals(this.gender, saleCreateTransactionRequestRiskData.gender) &&
        Objects.equals(this.dateOfBirth, saleCreateTransactionRequestRiskData.dateOfBirth) &&
        Objects.equals(this.billingPhoneNumber, saleCreateTransactionRequestRiskData.billingPhoneNumber) &&
        Objects.equals(this.billingAddress1, saleCreateTransactionRequestRiskData.billingAddress1) &&
        Objects.equals(this.billingAddress2, saleCreateTransactionRequestRiskData.billingAddress2) &&
        Objects.equals(this.billingCity, saleCreateTransactionRequestRiskData.billingCity) &&
        Objects.equals(this.billingState, saleCreateTransactionRequestRiskData.billingState) &&
        Objects.equals(this.billingPostalCode, saleCreateTransactionRequestRiskData.billingPostalCode) &&
        Objects.equals(this.billingCountryCode, saleCreateTransactionRequestRiskData.billingCountryCode) &&
        Objects.equals(this.email, saleCreateTransactionRequestRiskData.email) &&
        Objects.equals(this.productType, saleCreateTransactionRequestRiskData.productType) &&
        Objects.equals(this.productDescription, saleCreateTransactionRequestRiskData.productDescription) &&
        Objects.equals(this.productItem, saleCreateTransactionRequestRiskData.productItem) &&
        Objects.equals(this.productQuantity, saleCreateTransactionRequestRiskData.productQuantity) &&
        Objects.equals(this.productPrice, saleCreateTransactionRequestRiskData.productPrice) &&
        Objects.equals(this.orderNumber, saleCreateTransactionRequestRiskData.orderNumber) &&
        Objects.equals(this.sellerId, saleCreateTransactionRequestRiskData.sellerId) &&
        Objects.equals(this.flightData, saleCreateTransactionRequestRiskData.flightData) &&
        Objects.equals(this.flightPassengers, saleCreateTransactionRequestRiskData.flightPassengers) &&
        Objects.equals(this.customParameters, saleCreateTransactionRequestRiskData.customParameters)&&
        Objects.equals(this.additionalProperties, saleCreateTransactionRequestRiskData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SaleCreateTransactionRequestRiskData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SaleCreateTransactionRequestRiskData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SaleCreateTransactionRequestRiskData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SaleCreateTransactionRequestRiskData is not found in the empty JSON string", SaleCreateTransactionRequestRiskData.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("FlightData") != null && !jsonObj.get("FlightData").isJsonNull()) {
        SaleCreateTransactionRequestRiskDataFlightData.validateJsonObject(jsonObj.getAsJsonObject("FlightData"));
      }
      if (jsonObj.get("FlightPassengers") != null && !jsonObj.get("FlightPassengers").isJsonNull()) {
        ...
        if (jsonArrayflightPassengers != null) {
          ...
          for (int i = 0; i < jsonArrayflightPassengers.size(); i++) {
            SaleCreateTransactionRequestRiskDataFlightPassengersInner.validateJsonObject(jsonArrayflightPassengers.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SaleCreateTransactionRequestRiskData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SaleCreateTransactionRequestRiskData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SaleCreateTransactionRequestRiskData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SaleCreateTransactionRequestRiskData.class));

       return (TypeAdapter<T>) new TypeAdapter<SaleCreateTransactionRequestRiskData>() {
           @Override
           public void write(JsonWriter out, SaleCreateTransactionRequestRiskData value) throws IOException {
           ...
           @Override
           public SaleCreateTransactionRequestRiskData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SaleCreateTransactionRequestRiskData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SaleCreateTransactionRequestRiskData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SaleCreateTransactionRequestRiskData
  * @throws IOException if the JSON string is invalid with respect to SaleCreateTransactionRequestRiskData
  */
  public static SaleCreateTransactionRequestRiskData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SaleCreateTransactionRequestRiskData.class);
  }

 /**
  * Convert an instance of SaleCreateTransactionRequestRiskData to an JSON string
  *
  * @return JSON string
  */
