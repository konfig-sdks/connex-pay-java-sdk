 ...
 */
@ApiModel(description = "URL Links (email) or a text document (fax) to virtual cards can be emailed/faxed by including the VCC Transmission object in the IssueCard API call. Including the transmission object for email also allows you to pull back a URL you can use within your application to direct a user to a visual representation of the virtual card.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CardIssuanceCreateVirtualCardRequestTransmission {
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission() {
  }

  public CardIssuanceCreateVirtualCardRequestTransmission transmissionMethods(List<String> transmissionMethods) {
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission addTransmissionMethodsItem(String transmissionMethodsItem) {
  ...
  **/
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission emailRecipient(String emailRecipient) {
  ...
  **/
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission merchantPhoneNumber(String merchantPhoneNumber) {
  ...
  **/
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission emailFrom(String emailFrom) {
  ...
  **/
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission recipientName(String recipientName) {
  ...
  **/
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission subject(String subject) {
  ...
  **/
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission message(String message) {
  ...
  **/
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission daysToExpire(String daysToExpire) {
  ...
  **/
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission faxFrom(String faxFrom) {
  ...
  **/
  ...
  public CardIssuanceCreateVirtualCardRequestTransmission faxRecipient(String faxRecipient) {
  ...
  **/
   ...
   * @return the CardIssuanceCreateVirtualCardRequestTransmission instance itself
   */
  public CardIssuanceCreateVirtualCardRequestTransmission putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CardIssuanceCreateVirtualCardRequestTransmission cardIssuanceCreateVirtualCardRequestTransmission = (CardIssuanceCreateVirtualCardRequestTransmission) o;
    return Objects.equals(this.transmissionMethods, cardIssuanceCreateVirtualCardRequestTransmission.transmissionMethods) &&
        Objects.equals(this.emailRecipient, cardIssuanceCreateVirtualCardRequestTransmission.emailRecipient) &&
        Objects.equals(this.merchantPhoneNumber, cardIssuanceCreateVirtualCardRequestTransmission.merchantPhoneNumber) &&
        Objects.equals(this.emailFrom, cardIssuanceCreateVirtualCardRequestTransmission.emailFrom) &&
        Objects.equals(this.recipientName, cardIssuanceCreateVirtualCardRequestTransmission.recipientName) &&
        Objects.equals(this.subject, cardIssuanceCreateVirtualCardRequestTransmission.subject) &&
        Objects.equals(this.message, cardIssuanceCreateVirtualCardRequestTransmission.message) &&
        Objects.equals(this.daysToExpire, cardIssuanceCreateVirtualCardRequestTransmission.daysToExpire) &&
        Objects.equals(this.faxFrom, cardIssuanceCreateVirtualCardRequestTransmission.faxFrom) &&
        Objects.equals(this.faxRecipient, cardIssuanceCreateVirtualCardRequestTransmission.faxRecipient)&&
        Objects.equals(this.additionalProperties, cardIssuanceCreateVirtualCardRequestTransmission.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CardIssuanceCreateVirtualCardRequestTransmission {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardIssuanceCreateVirtualCardRequestTransmission
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardIssuanceCreateVirtualCardRequestTransmission.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardIssuanceCreateVirtualCardRequestTransmission is not found in the empty JSON string", CardIssuanceCreateVirtualCardRequestTransmission.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardIssuanceCreateVirtualCardRequestTransmission.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardIssuanceCreateVirtualCardRequestTransmission' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardIssuanceCreateVirtualCardRequestTransmission> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardIssuanceCreateVirtualCardRequestTransmission.class));

       return (TypeAdapter<T>) new TypeAdapter<CardIssuanceCreateVirtualCardRequestTransmission>() {
           @Override
           public void write(JsonWriter out, CardIssuanceCreateVirtualCardRequestTransmission value) throws IOException {
           ...
           @Override
           public CardIssuanceCreateVirtualCardRequestTransmission read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CardIssuanceCreateVirtualCardRequestTransmission instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CardIssuanceCreateVirtualCardRequestTransmission given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CardIssuanceCreateVirtualCardRequestTransmission
  * @throws IOException if the JSON string is invalid with respect to CardIssuanceCreateVirtualCardRequestTransmission
  */
  public static CardIssuanceCreateVirtualCardRequestTransmission fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardIssuanceCreateVirtualCardRequestTransmission.class);
  }

 /**
  * Convert an instance of CardIssuanceCreateVirtualCardRequestTransmission to an JSON string
  *
  * @return JSON string
  */
