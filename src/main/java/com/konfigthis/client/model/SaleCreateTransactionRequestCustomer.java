 ...
 */
@ApiModel(description = "Customer Data. This will only be used if TenderType is not Credit")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SaleCreateTransactionRequestCustomer {
  ...
  public SaleCreateTransactionRequestCustomer() {
  }

  public SaleCreateTransactionRequestCustomer firstName(String firstName) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer lastName(String lastName) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer phone(String phone) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer city(String city) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer state(String state) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer country(String country) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer email(String email) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer address1(String address1) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer address2(String address2) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer zip(String zip) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer dateOfBirth(LocalDate dateOfBirth) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer driversLicenseNumber(Integer driversLicenseNumber) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer driversLicenseState(String driversLicenseState) {
  ...
  **/
  ...
  public SaleCreateTransactionRequestCustomer SSN4(Integer SSN4) {
  ...
  **/
   ...
   * @return the SaleCreateTransactionRequestCustomer instance itself
   */
  public SaleCreateTransactionRequestCustomer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SaleCreateTransactionRequestCustomer saleCreateTransactionRequestCustomer = (SaleCreateTransactionRequestCustomer) o;
    return Objects.equals(this.firstName, saleCreateTransactionRequestCustomer.firstName) &&
        Objects.equals(this.lastName, saleCreateTransactionRequestCustomer.lastName) &&
        Objects.equals(this.phone, saleCreateTransactionRequestCustomer.phone) &&
        Objects.equals(this.city, saleCreateTransactionRequestCustomer.city) &&
        Objects.equals(this.state, saleCreateTransactionRequestCustomer.state) &&
        Objects.equals(this.country, saleCreateTransactionRequestCustomer.country) &&
        Objects.equals(this.email, saleCreateTransactionRequestCustomer.email) &&
        Objects.equals(this.address1, saleCreateTransactionRequestCustomer.address1) &&
        Objects.equals(this.address2, saleCreateTransactionRequestCustomer.address2) &&
        Objects.equals(this.zip, saleCreateTransactionRequestCustomer.zip) &&
        Objects.equals(this.dateOfBirth, saleCreateTransactionRequestCustomer.dateOfBirth) &&
        Objects.equals(this.driversLicenseNumber, saleCreateTransactionRequestCustomer.driversLicenseNumber) &&
        Objects.equals(this.driversLicenseState, saleCreateTransactionRequestCustomer.driversLicenseState) &&
        Objects.equals(this.SSN4, saleCreateTransactionRequestCustomer.SSN4)&&
        Objects.equals(this.additionalProperties, saleCreateTransactionRequestCustomer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SaleCreateTransactionRequestCustomer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SaleCreateTransactionRequestCustomer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SaleCreateTransactionRequestCustomer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SaleCreateTransactionRequestCustomer is not found in the empty JSON string", SaleCreateTransactionRequestCustomer.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SaleCreateTransactionRequestCustomer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SaleCreateTransactionRequestCustomer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SaleCreateTransactionRequestCustomer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SaleCreateTransactionRequestCustomer.class));

       return (TypeAdapter<T>) new TypeAdapter<SaleCreateTransactionRequestCustomer>() {
           @Override
           public void write(JsonWriter out, SaleCreateTransactionRequestCustomer value) throws IOException {
           ...
           @Override
           public SaleCreateTransactionRequestCustomer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SaleCreateTransactionRequestCustomer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SaleCreateTransactionRequestCustomer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SaleCreateTransactionRequestCustomer
  * @throws IOException if the JSON string is invalid with respect to SaleCreateTransactionRequestCustomer
  */
  public static SaleCreateTransactionRequestCustomer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SaleCreateTransactionRequestCustomer.class);
  }

 /**
  * Convert an instance of SaleCreateTransactionRequestCustomer to an JSON string
  *
  * @return JSON string
  */
